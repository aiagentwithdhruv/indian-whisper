      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="mt-12">
          <a
            ...
            className="glow-blue inline-flex items-center gap-4 px-10 py-5 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold text-xl hover:from-blue-500 hover:to-blue-400 transition-all duration-300 transform hover:scale-[1.02]"
          >
